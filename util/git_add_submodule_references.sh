...
Win7DEV_BASEDIR=/media/sf_D_DRIVE/h/prj/1original/project
...
git_submod_add   git@github.com:GerHobbelt/qunit.git                                     test/qunit
git_submod_add   git@github.com:GerHobbelt/sizzle.git                                    src/sizzle
